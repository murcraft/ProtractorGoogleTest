...
describe('Search Buildings To 20000 - Search Buildings to 10000: ', () => {

  let randomText = RandomHelper.GetRandomString('log')
  let typeaheadFileName = `typeahead_search10000_${randomText}.txt`

  let buildingsArr = []
  let buildingAddress
  let buildingId
  let initialCheckedNumber = 5000
  let checkedBuildingsNumber = 10000
  let recordedFile
