...
describe('Search Buildings To 20000 - Search Buildings to 18000: ', () => {

  let randomText = RandomHelper.GetRandomString('log')
  let typeaheadFileName = `typeahead_search11000_${randomText}.txt`

  let buildingsArr = []
  let buildingAddress
  let buildingId
  let initialCheckedNumber = 16000
  let checkedBuildingsNumber = 18000
  let recordedFile
