...
describe('Search Buildings To 20000 - Search Buildings to 16000: ', () => {

  let randomText = RandomHelper.GetRandomString('log')
  let typeaheadFileName = `typeahead_search16000_${randomText}.txt`

  let buildingsArr = []
  let buildingAddress
  let buildingId
  let initialCheckedNumber = 14000
  let checkedBuildingsNumber = 16000
  let recordedFile
