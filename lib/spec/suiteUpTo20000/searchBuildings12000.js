...
describe('Search Buildings To 20000 - Search Buildings to 12000: ', () => {

  let randomText = RandomHelper.GetRandomString('log')
  let typeaheadFileName = `typeahead_search12000_${randomText}.txt`

  let buildingsArr = []
  let buildingAddress
  let buildingId
  let initialCheckedNumber = 8000
  let checkedBuildingsNumber = 12000
  let recordedFile
