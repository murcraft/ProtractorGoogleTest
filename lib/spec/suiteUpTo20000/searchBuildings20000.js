...
describe('Search Buildings To 20000 - Search Buildings to 20000: ', () => {

  let randomText = RandomHelper.GetRandomString('log')
  let typeaheadFileName = `typeahead_search20000_${randomText}.txt`

  let buildingsArr = []
  let buildingAddress
  let buildingId
  let initialCheckedNumber = 15000
  let checkedBuildingsNumber = 20000
  let recordedFile
