...
describe('Search Buildings To 30000 - Search Buildings to 28000: ', () => {

  let randomText = RandomHelper.GetRandomString('log')
  let typeaheadFileName = `typeahead_search28000_${randomText}.txt`

  let buildingsArr = []
  let buildingAddress
  let buildingId
  let initialCheckedNumber = 26000
  let checkedBuildingsNumber = 28000
  let recordedFile
