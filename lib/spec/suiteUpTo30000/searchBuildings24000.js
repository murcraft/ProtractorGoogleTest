...
describe('Search Buildings To 30000 - Search Buildings to 24000: ', () => {

  let randomText = RandomHelper.GetRandomString('log')
  let typeaheadFileName = `typeahead_search22000_${randomText}.txt`

  let buildingsArr = []
  let buildingAddress
  let buildingId
  let initialCheckedNumber = 22000
  let checkedBuildingsNumber = 24000
  let recordedFile
