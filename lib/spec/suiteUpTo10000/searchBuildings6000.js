...
describe('Search Buildings To 20000 - Search Buildings to 6000: ', () => {

  let randomText = RandomHelper.GetRandomString('log')
  let typeaheadFileName = `typeahead_search6000_${randomText}.txt`

  let buildingsArr = []
  let buildingAddress
  let buildingId
  let initialCheckedNumber = 4000
  let checkedBuildingsNumber = 6000
  let recordedFile
