...
describe('Search Buildings To Last - Search Buildings to 52000: ', () => {

  let randomText = RandomHelper.GetRandomString('log')
  let typeaheadFileName = `typeahead_search52000_${randomText}.txt`

  let buildingsArr = []
  let buildingAddress
  let buildingId
  let initialCheckedNumber = 50000
  let checkedBuildingsNumber = 52000
  let recordedFile
