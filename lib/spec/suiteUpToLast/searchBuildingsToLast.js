...
describe('Search Buildings To Last - Search Buildings to Last: ', () => {

  let randomText = RandomHelper.GetRandomString('log')
  let typeaheadFileName = `typeahead_searchToLast_${randomText}.txt`

  let buildingsArr = []
  let buildingAddress
  let buildingId
  let initialCheckedNumber = 58000
  let checkedBuildingsNumber
  let recordedFile
