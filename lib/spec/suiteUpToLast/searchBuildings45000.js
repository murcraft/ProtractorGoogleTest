...
describe('Search Buildings To Last - Search Buildings to 45000: ', () => {

  let randomText = RandomHelper.GetRandomString('log')
  let typeaheadFileName = `typeahead_search45000_${randomText}.txt`

  let buildingsArr = []
  let buildingAddress
  let buildingId
  let initialCheckedNumber = 40000
  let checkedBuildingsNumber = 45000
  let recordedFile
