...
describe('Search Buildings To Last - Search Buildings to 55000: ', () => {

  let randomText = RandomHelper.GetRandomString('log')
  let typeaheadFileName = `typeahead_search55000_${randomText}.txt`

  let buildingsArr = []
  let buildingAddress
  let buildingId
  let initialCheckedNumber = 50000
  let checkedBuildingsNumber = 55000
  let recordedFile
