...
describe('Search Buildings To 40000 - Search Buildings to 34000: ', () => {

  let randomText = RandomHelper.GetRandomString('log')
  let typeaheadFileName = `typeahead_search34000_${randomText}.txt`

  let buildingsArr = []
  let buildingAddress
  let buildingId
  let initialCheckedNumber = 32000
  let checkedBuildingsNumber = 34000
  let recordedFile
