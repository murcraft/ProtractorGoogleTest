...
describe('Search Buildings To 40000 - Search Buildings to 25000: ', () => {

  let randomText = RandomHelper.GetRandomString('log')
  let typeaheadFileName = `typeahead_search25000_${randomText}.txt`

  let buildingsArr = []
  let buildingAddress
  let buildingId
  let initialCheckedNumber = 20000
  let checkedBuildingsNumber = 25000
  let recordedFile
