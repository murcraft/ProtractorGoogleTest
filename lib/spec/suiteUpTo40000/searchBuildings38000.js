...
describe('Search Buildings To 40000 - Search Buildings to 38000: ', () => {

  let randomText = RandomHelper.GetRandomString('log')
  let typeaheadFileName = `typeahead_search38000_${randomText}.txt`

  let buildingsArr = []
  let buildingAddress
  let buildingId
  let initialCheckedNumber = 36000
  let checkedBuildingsNumber = 38000
  let recordedFile
