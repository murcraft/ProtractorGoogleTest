...
describe('Search Buildings To 50000 - Search Buildings to 42000: ', () => {

  let randomText = RandomHelper.GetRandomString('log')
  let typeaheadFileName = `typeahead_search42000_${randomText}.txt`

  let buildingsArr = []
  let buildingAddress
  let buildingId
  let initialCheckedNumber = 40000
  let checkedBuildingsNumber = 42000
  let recordedFile
