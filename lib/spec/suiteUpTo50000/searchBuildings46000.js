...
describe('Search Buildings To 50000 - Search Buildings to 46000: ', () => {

  let randomText = RandomHelper.GetRandomString('log')
  let typeaheadFileName = `typeahead_search46000_${randomText}.txt`

  let buildingsArr = []
  let buildingAddress
  let buildingId
  let initialCheckedNumber = 44000
  let checkedBuildingsNumber = 46000
  let recordedFile
