...
describe('Search Buildings To 50000 - Search Buildings to 48000: ', () => {

  let randomText = RandomHelper.GetRandomString('log')
  let typeaheadFileName = `typeahead_search48000_${randomText}.txt`

  let buildingsArr = []
  let buildingAddress
  let buildingId
  let initialCheckedNumber = 46000
  let checkedBuildingsNumber = 48000
  let recordedFile
